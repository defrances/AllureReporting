...
export function setupUnicodeFont(pdf) {
  try {
    if (HAS_UNICODE_FONT) {
...
export function getDurationMs(timeObj, fallbackDuration) {
...
export async function addImageToPdf(pdf, imageUrl, attachment, x, yPos, pageWidth, pageHeight, setupUnicodeFontFn) {
